...
# Set your API key
os.environ["GOOGLE_API_KEY"] = "AIzaSyBsgW4yLi745sCWT3GGhCjFmuLYIJTiAWg"
...
def Question_mcqs_generator(input_text, num_questions, difficulty):
    prompt = f"""
    You are an AI assistant helping the user generate multiple-choice questions (MCQs) from the following text:
    '{input_text}'
    Please generate {num_questions} {difficulty} MCQs. These questions should include a mix of:
    - Simple MCQs
    - Match the pair MCQs
...
def generate_mcqs():
    ...
    difficulty = request.form['difficulty']  # Get the difficulty level from the form
